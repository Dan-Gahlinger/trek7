...
C            -- DONALD ECCLESTONE AND DAN GAHLINGER FOR T R E K 7 --
C
...
C
      ...
      COMMON /A/IT,IS,TI(2),IJ(2),I3,JS,ISHAK,NOSTOP
     ...
     *IGNORE,IO,IGOL(80)
      ...
      COMMON /N/INAME(3,4),IENM2(4,8),ISIDE(3,2),IBASE(4)
      COMMON /O/MA(4,33),K(4,14),NOMAP(4),MANUM(4),HIVEL(4,2),ITEMP(4),NOMOV(4)
...
3337  FORMAT(' TEMPERATURES ARE BOYOND CRITICAL POINT')
      PAUSE 10
      CALL LIB$ERASE_LINE(17,1)
      IF(ITEMP(IT).GE.7500)CALL LIB$SET_CURSOR(17,1)
      IF(ITEMP(IT).GE.7500)WRITE(L,3338)
3338  FORMAT(' EXPLOSION IMMINENT!!!')
      IF(ITEMP(IT).GE.7500)PAUSE 10
      IF(ITEMP(IT).GE.7500)CALL LIB$ERASE_LINE(17,1)
      CALL RANDO(I7,100)
      IF(I7.GT.(ITEMP()-6200)/100)GO TO 546
...
3339  FORMAT(' ENGINEERING HERE SIR - MATTER AND ANTI-MATTER ARE NO WIT
     ...
     *UE TO PROXIMITY OF BLAST-')
      PAUSE 10
      CALL LIB$ERASE_LINE(17,1)
C ABOVE TWO LINES COME FROM A PLACE I KNOW NOT WHERE - DG NOV. 15/1999
      DO 162    I7=1,4
      IF(ICHOE(I7).EQ.O)GO TO 162
      IF(I7.EQ.IT)GO TO 162
      I8=I7+4
C LINE THAT FOLLOWS IQO AND IQ0 DISTINCTION MAY BE INCORRECT - DG NOV. 15/1999
...
C
     ...
     *IGNORE,IO,IGOL(80)
      COMMON /D/DFLCT(4),DFLCK(6),DFLCB(2)
     ...
     *IBASR(2),IBASC(2),LI2(4),LI2R(5),LI2C(5),IGD(4),MINES
      ...
      I8=I7+4
      WRITE(I8,5)(ISIDE(IGO,I),100=1,3),IBASE(I),(INAME(IQ0,MIN),IQ0=1,3)
...
3     IF(MIN.GT.6)GO TO 6
     ...
     *(ISIDE(IQ0,MIN),100=1,3),IBASE(MIN)
8     FORMAT(/1X,3A4,' STRBS',I3,' HIT ',3A4,' STRBS',I3,'-DMG REPORT-')
7     CONTINUE
...
17    FORMAT(/1X,3A4,' STRBS',I3,' PHASRS BOUNCED OFF DOOMSDAY MACHINE')
16    CONTINUE
      GO TO 1
15    DO 9 I7=1,4
      IF(ICHOE(I7).EQ.O)GO TO 9
      I8=I7+4
...
C
      SUBROUTINE TALOS
      COMMON /C/L,A,B,I,NA,IV,I7,IB,N,DISTP,AJUST,MIN,ISTAT,JTK,KOENIG,
     *IGNORE,IO,IGOL(80)
...
C
      ...
      COMMON /L/IENTR(4),IENTC(4),IKLNR(8),IKLNC(13),IGLER(25),IGLEC(25)
     *IBASR(2),IBASC(2),LI2(4),LI2R(5),LI2C(5),IGO(4),MINES
      COMMON /T/ICHOE(4),ICHOS(8),ICHOB(2)
      MOLOCH=.FALSE.
      IF(MIN.GT.4)GO TO 1
...
C
     ...
     *IBASR(2),IBABC(2),LI2(4),LI2R(5),LI2C(5),IGO(4),MINES
      COMMON /N/INAME(3,4),IENM2(4,6),ISIDE(3,2),IBASE(2)
      COMMON /R/IBPSC(4),IBPSB(8),IBPSS(2),IBPSE(25)
      COMMON /T/ICHOE(4),ICHOS(8),ICHOB(2)
...
321   CALL PIKE(IGLER(I7),IGLEC(I7),IBPSE(I7))
      ...
      I8=I7+4
      WRITE(I8,326)(ISID(IQ0,IS),IGO=1,3),(INAME(IQ0,MI),IQ0=1,3)
326   FORMAT(/1X,3A4,' BOARDED EAGLES HIT ',3A4,'-DAMAGE REPORT-')
325   CONTINUE
      CALL GRUP1(LIRPA(DFLCT(MI),IV),Ml)
      GO TO 1110
...
333   CONTINUE
      CALL GRUP3(LIRPA(DFLCK(Ml),IV),MI)
      GO TO 1110
332   MI=MIN-14
      DO 336 I7=1,4
...
C
     ...
     *IGNORE,IO,IGOL(80)
      COMMON /N/INAME(3,4),IENM2(4,8),ISIDE(3,2),IBASE(2)
      COMMON /T/ICVJOE(4),ICHOS(8),ICHOB(2)
      COMMON /V/IWEB(2),IWEBZ,INVIS(4)
      ...
      I8=I7+4
      WRITE(I8,11O2)(INAME(IQ0)MIN),IQ0=1,3),(IWHE(IQ0,NN),IQ0=1,3)
...
359   IF(IARMZ(1).EQ.O)GO TO 360
      IV=INDUZ
      DO 357 I7=1,4
      IF(ICHOE(I7).EQ.O)GO TO 357
      I8=I7+4
      WRITE(I8,358)
...
C
     ...
     *IGNORE,IO,IGOL(80)
      COMMON /D/DFLCT(4),DFLCK(8),DFLCB(2)
      COMMON /l/IONK(8),ISPOK(8),ION(4),ISPOT(4)
      COMMON /N/INAME(3,4),IENM2(4,8),ISIDE(3,2),IBASE(2)
      COMMON /T/ICHOE(4),ICHOS(8),ICHOB(2)
        COMMON /TOM/ITOM
...
C
      SUBROUTINE SAURON
      COMMON /A/IT,IS,II(2),TI(2),I3,JS,ISHAK,NOSTOP
      COMMON /C/L,A,B,I,NA,IV,I7,I8,N,DISTP,AJUST,MIN,ISTAT,JTK,KOENIG,
     *IGNORE,IO,IGOL(80)
      COMMON /D/DFLCT(4),DFLCK(8),DFLCB(2)
      COMMON /E/PHASR(4),TWARP(4),IPHOT(4),NDEAD(4),ISURR(4)
     ...
     *TBASR(2),IBASC(2),LI2(4),LI2R(5),LI2C(5),IGO(4),MINES
      COMMON /N/INAME(3,4),IENM2(4,8),ISIDE(3,2),IBASE(2)
...
23303 IF(IGO(IT).EQ.1)GO TO 23302
      IF(PHASR(I,R)+DFLCT(IT)*100.+TWARP(IT)*1000.0.GE.26000.)GO TO 23302
...
C AND OUR HEARTS WILL BE WITH YOU ALWAYS.  MR. KELLEY WILL BE SADLY MISSED.
     ...
     *IGNORE,IO,IGOL(80)
      ...
      COMMON /O/MA(4,33),K(4,14),NOMAP(4),MANUM(4),HIVEL(4,2),ITEMP(4),
     *NOMOV(4)
      WRITE(L,2)INAME(1,IT),INAME(2,IT),IBASE(I)
...
3     CONTINUE
      ...
      IF(PHASR(IT)+DFCLT(IT)*100.+TWARP(IT)*1000.0.GE.26000.)GOTO 5
      DFLCT(IT)=DFCLT(IT)+10.
      IF(PHASR(IT).LT.6000.)PHASR(IT)=PHASR(IT)+500.
      TWARP(IT)=TWARP(IT)+1.
      IF(DFCLT(IT).GT.100.)DFLCT(IT)=100.
      IF(TWARP(IT).GT.10.)TWARP(IT)=10.
